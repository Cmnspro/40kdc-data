...
- `6` — stat-modifier AP on the attacker: defender-side AP reduction is not modelled by the buff layer
...
- `3` — conditional: cannot evaluate condition "destroyed-by-attack-type" against current context
